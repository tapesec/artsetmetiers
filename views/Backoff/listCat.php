...
<?php echo $this->Form->input(array('name' => 'cat_type',
				 'type' => 'select',
				 'value' => $value = (isset($edit['cat_type']))? $edit['cat_type'] : '',
				 'list' => array('blog' => 'blog', 'tuto' => 'tutoriel'))); ?>
